...
preview_grafico() { echo "Gráfico: GIMP, Inkscape, Blender, Krita, Darktable, RawTherapee, FreeCAD, LibreCAD, SolveSpace"; }
...
instalar_grafico() {
  timer apt install -y gimp inkscape blender krita darktable rawtherapee freecad librecad solvespace
  progress_bar 12
}
